...
void pwm_timer_gpio()
{
	 ...
	 *		mgt-drv0-pwm0	  PA1	TIM2_CH2 AF1 CHANGED INTO A REGULAR GPIO
	 *		mgt-drv1-pwm1	  PB10	TIM2_CH3 AF1
	 *		mgt-drv1-pwm0	  PB11	TIM2_CH4 AF1 CHANGED INTO A REGULAR GPIO
	 *		mgt-drv2-pwm0	  PA9	TIM1_CH2 AF1 CHANGED INTO A REGULAR GPIO
	...
	// Set pin mode
	GPIOA->MODER |= (GPIO_MODER_MODE0_1 | GPIO_MODER_MODE8_1);
	...
	PWMTimerDRV0->CR1 |= TIM_CR1_ARPE;
	PWMTimerDRV1->CR1 |= TIM_CR1_ARPE;
	PWMTimerDRV2->CR1 |= TIM_CR1_ARPE;
}
...
bool pwm_initTimer(PWM_Channels channel, uint32_t period)
{
	...
	case DRV2_PWM1:
		...
		PWMTimerDRV2->CCMR1 |= TIM_CCMR1_OC1PE;
...
void pwm_enableChannel(PWM_Channels channel)
{
	...
	case DRV1_PWM1:
		...
		break;
	case DRV2_PWM0:
		PWMTimerDRV2->CCER |= TIM_CCER_CC2E;
		break;
	case DRV2_PWM1:
		PWMTimerDRV2->CCER |= TIM_CCER_CC1E;
		break;
	}
}
